        ...
        <section id="hero" className="pt-20 sm:pt-20 md:pt-20 flex px-6 lg:px-16 mb-10 lg:mb-10 items-center justify-center">
            ...
            <div className="self-center rounded-lg border border-zinc-300 dark:border-zinc-800 bg-[#eae8e5] dark:bg-zinc-900 p-6">
                ...
                <div className="lg:w-[80%] text-zinc-900 dark:text-zinc-100 self-center">
                    <h2 className="text-xl">{user_info.main.role} <p className=' inline text-base font-light'>from</p><span><img src="/flag-pakistan.svg" alt="Pakistan" className="inline mx-1 mb-1 w-6 h-6"/></span></h2>
