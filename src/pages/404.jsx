                ...
                <div className='flex h-screen justify-center px-6'>
                    <div className='self-center text-zinc-900 dark:text-zinc-300'>
                        <div className='flex text-5xl justify-center font-bold gap-4'>
                            Page Not Found <FaScrewdriverWrench />
                        </div>
                        ...
                        <div className='text-center mt-6'>
                            <button onClick={() => navigate("/")} className='bg-[#8364D8] hover:bg-[#8364D8] hover:px-5 transition-all duration-300 text-white px-4 py-2 rounded'>Go to homepage</button>
                        </div>
                    </div>
                </div>
            </div>
