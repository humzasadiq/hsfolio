...
import nekoGif from '/oneko/oneko-classic.gif'; // Adjust the path as necessary

let nekoInitialized = false;

const Neko = () => {
  useEffect(() => {
    if (nekoInitialized) return;
    (function oneko() {
      const nekoEl = document.createElement('div');
      let nekoPosX = window.innerWidth * 0.15,
        nekoPosY = 14,
        mousePosX = 0,
        mousePosY = 0,
        frameCount = 0,
